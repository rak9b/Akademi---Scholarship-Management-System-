...
const FAQ = () => {
    return (
        <section className='max-w-screen-2xl py-20 px-5 sm:px-7 md:px-10 mx-auto flex flex-col lg:flex-row md:gap-9 xl:gap-14 bg-white'>
            <div className='w-full lg:max-w-[50%]'>
                <div>
                    <p className='uppercase text-green-600 text-sm sm:text-base'>——— Ask questions</p>
                    <h3 className='font-bold text-3xl sm:text-4xl md:text-5xl pb-12 pt-5 leading-[58px]'>Uncover your potential with <span className='text-green-600'>Our</span> assistance</h3>
                </div>
                <div className='relative'>
                    ...
                    <div className='absolute bottom-0 m-3 sm:m-5 md:m-7 flex justify-center items-center gap-5 md:gap-10 p-4 md:p-8 max-w-max bg-white rounded-lg'>
                        ...
                        <button className='btn transition-colors duration-300 hover:bg-green-400 hover:text-black bg-black text-white border-none'>Get In Touch</button>
                    </div>
                </div>
            </div>
