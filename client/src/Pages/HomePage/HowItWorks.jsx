...
const HowItWorks = () => {
  return (
    <section className='max-w-screen-2xl py-20 px-5 sm:px-7 md:px-10 mx-auto'>
      <div className='sm:p-14 py-10 px-7 rounded-lg text-white bg-black border border-green-600/20 shadow-2xl'>
        <div className='text-center'>
          <p className='uppercase text-sm sm:text-base'>——— our process ———</p>
          <h2 className='font-bold text-3xl sm:text-4xl md:text-5xl pb-12 pt-5'>How <span className="text-green-400">Akademi</span> Works?</h2>
        </div>
        <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 justify-center items-center'>
          <div className='group mx-auto max-w-72 hover:cursor-pointer px-5'>
            ...
            <div className='text-center flex flex-col gap-3 mt-7'>
              ...
              <p className='bg-green-400 text-black w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full mx-auto text-xl font-bold'>1</p>
            </div>
          </div>
          <div className='group mx-auto max-w-72 hover:cursor-pointer px-5'>
            <div className='flex justify-center items-center text-black w-[92px] h-[92px] md:h-[116px] md:w-[116px] rounded-full border-2 border-white mx-auto'>
            ...
            <div className='text-center flex flex-col gap-3 mt-7'>
              ...
              <p className='bg-green-400 text-black w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full mx-auto text-xl font-bold'>2</p>
            </div>
          </div>
          <div className='group mx-auto max-w-72 hover:cursor-pointer px-5'>
            <div className='flex justify-center items-center text-black w-[92px] h-[92px] md:h-[116px] md:w-[116px] rounded-full border-2 border-white mx-auto'>
            ...
            <div className='text-center flex flex-col gap-3 mt-7'>
              ...
              <p className='bg-green-400 text-black w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full mx-auto text-xl font-bold'>3</p>
            </div>
          </div>
          <div className='group lg:col-span-3 xl:col-span-1 mx-auto max-w-72 hover:cursor-pointer px-5'>
            ...
            <div className='text-center flex flex-col gap-3 mt-7'>
              ...
              <p className='bg-green-400 text-black w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full mx-auto text-xl font-bold'>4</p>
            </div>
          </div>
